...
`audio_device_detection`은 안드로이드와 iOS에서 블루투스 오디오 기기(A2DP, Headset 등)의 연결 상태 변경을 감지하고, 현재 연결된 기기 목록을 가져올 수 있는 플러터 플러그인입니다.

## 기능

- 현재 연결된 오디오 기기 목록 조회
- 블루투스 오디오 기기의 연결/해제 실시간 감지 (Stream)
- 연결된 기기의 이름, 프로토콜 타입(A2DP, HEADSET 등) 정보 제공
